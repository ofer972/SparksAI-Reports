...
export interface TeamVelocityChartAdvancedViewProps {
  data: ClosedSprint[];
  loading: boolean;
  error: string | null;
...
const TeamVelocityChartAdvancedView: React.FC<TeamVelocityChartAdvancedViewProps> = ({
  data,
  loading,
  error,
  filters,
  ...
  const chartTitle = teamName ? `Velocity Chart - Advanced (${teamName})` : 'Velocity Chart - Advanced';

  return (
    <ReportCard
      title="Team Velocity Chart (Advanced)"
